-- Migration 0005 da joint_lesson_id filtri tushib qolgan edi (0002 da qo'shilgan,
-- 0005 da DROP+CREATE paytida yo'qolgan). Natijada bitta birlashtirilgan dars
-- doirasidagi guruh yozuvlari (bir xil slot, turli o'qituvchi/xona) soxta
-- teacher/room/class konflikt sifatida belgilanardi.
-- Bu migration shu filtrni qaytaradi.
