...
const DTS_GROUPS: { label: string; sinf: string; color: string; subjects: DtsSubject[] }[] = [
  ...
  },
  {
    ...
    subjects: [
      ...
      { name: "Kimyo", code: "KIM", color: "#10B981", weeklyHours: 2, requiredRoomType: "lab", description: "7–10=2soat, 11=1soat" },
      { name: "Biologiya", code: "BIO", color: "#14B8A6", weeklyHours: 2, requiredRoomType: "lab", description: "7–11-sinf, haftasiga 2 soat" },
      { name: "Geografiya", code: "GEOG", color: "#06B6D4", weeklyHours: 2, requiredRoomType: "classroom", description: "7–11-sinf, haftasiga 2 soat" },
      ...
      { name: "Davlat va huquq asoslari", code: "HUQ", color: "#EC4899", weeklyHours: 1, requiredRoomType: "classroom", description: "8–11-sinf, haftasiga 1 soat" },
      ...
      { name: "Chizmachilik", code: "CHIZMA", color: "#6366F1", weeklyHours: 1, requiredRoomType: "classroom", description: "Faqat 8-9-sinf, 1 soat" },
  ...
  },
  {
    ...
    subjects: [
      ...
      { name: "Chet tili (10–11)", code: "XORT11", color: "#06B6D4", weeklyHours: 2, requiredRoomType: "classroom", description: "10–11-sinf, haftasiga 2 soat" },
      ...
      { name: "Astronomiya", code: "ASTRO", color: "#6366F1", weeklyHours: 1, requiredRoomType: "classroom", description: "Faqat 11-sinf, 1 soat" },
      { name: "Kimyo (10–11)", code: "KIM11", color: "#10B981", weeklyHours: 2, requiredRoomType: "lab", description: "10=2soat, 11=1soat" },
      { name: "Biologiya (10–11)", code: "BIO11", color: "#14B8A6", weeklyHours: 2, requiredRoomType: "lab", description: "10–11-sinf, 2 soat" },
      { name: "Geografiya (10–11)", code: "GEOG11", color: "#06B6D4", weeklyHours: 2, requiredRoomType: "classroom", description: "10–11-sinf, 2 soat" },
      { name: "O'zbekiston tarixi (10–11)", code: "UZBT11", color: "#F59E0B", weeklyHours: 1, requiredRoomType: "classroom", description: "10–11-sinf, 1 soat" },
      { name: "Jahon tarixi (10–11)", code: "JTAR11", color: "#F59E0B", weeklyHours: 1, requiredRoomType: "classroom", description: "10–11-sinf, 1 soat" },
      { name: "Davlat va huquq asoslari (10–11)", code: "DHQ", color: "#EC4899", weeklyHours: 1, requiredRoomType: "classroom", description: "8–11-sinf, 1 soat" },
      { name: "Jismoniy tarbiya (10–11)", code: "JT11", color: "#F97316", weeklyHours: 2, requiredRoomType: "gym", description: "10–11-sinf, 2 soat" },
      { name: "Chaqiruvga qadar tayyorgarlik (CHQBT)", code: "CHQBT", color: "#EF4444", weeklyHours: 2, requiredRoomType: "classroom", description: "10–11-sinf, 2 soat (2025-2026 yangiligi)" },
    ],
  },
];
