...
const DTS_GROUPS: { label: string; sinf: string; color: string; subjects: DtsSubject[] }[] = [
  ...
  },
  {
    ...
    subjects: [
      ...
      { name: "Iqtisodiy bilim asoslari", code: "IQT", color: "#F59E0B", weeklyHours: 0.5, requiredRoomType: "classroom", description: "8-9-sinf, 0.5 soat (Geografiya bilan juftlashgan)" },
  ...
  },
  {
    ...
    subjects: [
      ...
      { name: "Geografiya (10-sinf)", code: "GEOG11", color: "#06B6D4", weeklyHours: 2, requiredRoomType: "classroom", description: "Faqat 10-sinf, 2 soat (11-sinfda yo'q)" },
      { name: "Tadbirkorlik asoslari", code: "TADBIR", color: "#F59E0B", weeklyHours: 1, requiredRoomType: "classroom", description: "Faqat 11-sinf, 1 soat" },
